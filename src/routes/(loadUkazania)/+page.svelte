...
<div class="sticky-top bg-dark text-light">
	<div class="container">
		<div class="d-flex flex-wrap align-items-center gap-1 mb-2 px-1 py-2">
			<div class="d-flex align-items-center gap-2 mb-1 mb-md-0">
				<b class="flex-grow-1 mb-0 text-light text-nowrap">Выбрать дату:</b>
			</div>
			<div class="d-flex align-items-center gap-1">
				...
				<a href="/" title="Следующий день" class="btn btn-dark" on:click={() => (date = nextDate())}
